    ...
    while (!done) : (iters += 1) {
        if (iters >= max_iters) {
            ...
            try stdout.print(
                ...
                .{
                    iters,
                    streams_finished_total,          total_streams,
                    c2s_dgrams_sent,                 total_dgrams_c2s,
                    dgrams_c2s_total,                dgrams_c2s_lost,
                    s2c_dgrams_sent,                 total_dgrams_s2c,
                    dgrams_s2c_total,                dgrams_s2c_lost,
                    sessions_closed_observed_server, num_sessions,
                    sessions_none_client,            sessions_pending_client,
                    sessions_established_client,     sessions_none_server,
                    num_sessions,
                },
            );
            try stdout.flush();
